<template>
  <div class="top-right-btn" :style="style">
    <el-row>
      <el-button text @click="toggleSearch()"><span style="color: var(--el-color-primary);"><span v-if="!showSearch">更多查询方案</span><span
          v-else>隐藏查询方案</span><el-icon style="vertical-align: text-top;"><component
          :is="showSearch ? ArrowUp : ArrowDown"/></el-icon></span></el-button>
      <el-button type="info" plain text @click="refresh()">刷新</el-button>
