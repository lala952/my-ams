...
export const useLockStore = defineStore('lock', {
    state: () => ({
        ...
        lockPath: localStorage.getItem(LOCK_PATH_KEY) || '/index.vue'
    }),
    actions: {
        // 锁定屏幕，同时记录当前路径
        lockScreen(currentPath) {
            this.lockPath = currentPath || '/index.vue'
        ...
        unlockScreen() {
            ...
            this.lockPath = '/index.vue'
            localStorage.setItem(LOCK_PATH_KEY, '/index.vue')
        }
    }
})
