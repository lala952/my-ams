...
public class VelocityUtils {
    ...
    public static List<String> getTemplateList(GenTable table) {
        ...
        /** Notice 若不使用MP，
         * 如若依的数表，数表会集成若依的TreeEntity,
         * 此时使用MP，会报错，
         * 因为MP会默认查实体类集成父类的所有字段，
         * 会出现SQL报错，所以需要树表的CRUD时，
         * 这里改为对应的mybatis包模版路径即可
         */
        ...
        templates.add("vm/java-mybatisplus/controller.java.vm");
        templates.add("vm/xml-mybatisplus/mapper.xml.vm");
        ...
        if (GenConstants.TPL_CRUD.equals(tplCategory)) {
            ...
            templates.add(useWebType + "/index.vue.vm");
            templates.add("vm/java-mybatisplus/sub-domain.java.vm");
        }
        if (isView) {
